...
static boolean isWhitespaceExceptNewline(int ch){
        if(ch == '\n' || ch == ' ') return false;
	return Character.isWhitespace(ch) || ch == ',';
}
...
static public Object read(PushbackReader r, boolean eofIsError, Object eofValue, boolean isRecursive)
	...
	try
		...
		for(; ;)
			...
			while(isWhitespaceExceptNewline(ch))
				ch = r.read();
			...
			if(ch == -1)
				...
				return eofValue;
                        ...
                        if(ch == '\n') {
                            return Symbol.create("MARG_NEWLINE");
                        }

                        if(ch == ' ') {
                            return Symbol.create("MARG_SPACE");
                        }
